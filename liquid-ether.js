class LiquidEther {
  constructor(container, options = {}) {
    ...
    this.options = {
      ...
      resolution: 0.5,
      isBounce: false,
      colors: ['#e0f5ff', '#f0f8ff', '#f8f0ff', '#e8f0ff', '#f0f8ff', '#e0f5ff'],
      autoDemo: true,
      autoSpeed: 0.8,
      autoIntensity: 2.5,
...
`;
    ...
    this.start = webgl.start.bind(webgl);
    this.pause = webgl.pause.bind(webgl);
  }
